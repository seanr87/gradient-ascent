...
Report the comparison in full. When notifying, the notification leads with the action and repeats the missing `ADD / DROP` lines verbatim from the claims file so Sean can paste without opening anything:

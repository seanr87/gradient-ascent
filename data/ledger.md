...
Last full rewrite: 2026-09-23 (built from every decision and post through Week 3 Tuesday). Last touched: 2026-09-26 (Sat QB swap, Johnson trade declined).
...
- **QB slot fixed off-cycle Sat 1:45 PM ET: Daniels benched, Mariota in.** Daniels ruled out Wk 3 (dislocated elbow, week-to-week, no IR); Mariota starts vs SEA. Nacua [Doubtful] and Evans [Q] stay in the nine until Sunday 9:00 AM. Source: `2026-wk03-sat-qb-swap`.

## Open threads
- **Daniels (QB, dislocated left elbow, now Out; Quinn started Mariota vs SEA, no fracture, specialists, no timetable).** **Swap issued Sat 2026-09-26 as a clipboard line, not just a conclusion** (`2026-wk03-sat-qb-swap`). Mariota starts for me until Daniels is cleared; drop Mariota that week, he has no other job here. Check status every run.
...
- **Hockenson for Emmett Johnson — DECLINED by The Wizard's Apprentice, confirmed by Sean Sat 2026-09-26.** Thread closed; Johnson's roster note deleted. Hockenson is again the drop of record (Mumpfield drops instead once Nacua and Evans are both confirmed active). Expected decline was right, the price was not the problem. Do not re-pitch a tight end into this league.
...
- **For Tuesday's process review, a third item: the Fri/Sat blind spot.** Nothing between Thu 5:00 PM and Sun 9:00 AM produces a decision, so a starter ruled out on Thursday stayed in the nine for two days and a Q-to-Doubtful downgrade went unread. Sean caught it, not a run. Proposed: any run that sees an Out or Doubtful player in the starting nine writes the swap immediately, plus a Saturday injury sweep. I cannot change `tasks/` myself.

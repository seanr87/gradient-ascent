...
- Routines run as `claude-opus-5` with tools Bash, Read, Write, Edit, Glob, Grep, WebSearch, WebFetch, PushNotification, in the Default cloud environment. They can push because Sean's GitHub account is connected to Claude (https://claude.ai/settings/connectors).
